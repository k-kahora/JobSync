...
config :jobsync, JobsyncWeb.Endpoint,
  ...
  check_origin: ["http://jobsync.buildertea.com:4000"],
  server: true
...
config :jobsync, Jobsync.Mailer, adapter: Swoosh.Adapters.Local
...
config :esbuild,
  ...
  jobsync: [
    args:
      ~w(js/storybook.js js/app.js --bundle --target=es2017 --outdir=../priv/static/assets --external:/fonts/* --external:/images/*),
